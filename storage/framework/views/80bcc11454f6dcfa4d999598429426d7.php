<?php $__env->startSection('title', 'Crear Promocion'); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form id="promocion-form" action="<?php echo e(route('promociones.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fecha_expiracion" name="fecha_expiracion" required min="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                </div>
            </div>
            <br>
...
<?php echo $__env->make('dashboard.layout.app_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Miguel\IdeaProjects\Shine-Go\resources\views\dashboard\promociones\create.blade.php ENDPATH**/ ?>