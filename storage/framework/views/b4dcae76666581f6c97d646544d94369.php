                ...
                <div class="authincation-content">
                    <div class="row no-gutters">
                        <div class="col-md-5 d-none d-md-flex align-items-center justify-content-center pl-5">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Register Image" class="img-fluid mb-4">
                        </div>
                        <div class="col-md-7">
                            <div class="auth-form">
                                <h3 class="text-center mb-4">Registro de Usuario</h3>
                                <form method="POST" action="<?php echo e(route('usuario.register')); ?>" id="registerForm">
                                    <?php echo csrf_field(); ?>
                                ...
                                <div class="new-account mt-3 text-center">
                                    <p>¿Ya tienes cuenta? <a class="text-primary" href="<?php echo e(route('login.form')); ?>">Iniciar sesión</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.on('submit', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('usuario.register')); ?>",
                type: 'POST',
                data: form.serialize(),
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Miguel\IdeaProjects\Shine-Go\resources\views\usuario\register.blade.php ENDPATH**/ ?>