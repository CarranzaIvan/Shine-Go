...
<div class="card">
    <div class="card-header" style="background-color: #0D5C75;">
        <h4 class="card-title text-white">Editar promoción</h4>
    </div>
    <div class="card-body">
        <form id="promocion-form" action="<?php echo e(route('promociones.update', $promocion->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo e($promocion->nombrePromocion); ?>" required autocomplete="off">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="descuento"><strong>Descuento (%)</strong></label>
                        <input type="number" class="form-control" id="descuento" name="descuento" value="<?php echo e($promocion->descuento); ?>" required min="5" max="50">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required><?php echo e($promocion->descripcion); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="servicio" value="<?php echo e($promocion->servicio->nomServicio); ?>" required autocomplete="off">
                        <input type="hidden" id="servicio_id" name="servicio_id" value="<?php echo e($promocion->servicio_id); ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fecha_expiracion" name="fecha_expiracion" value="<?php echo e($promocion->fecha_expiracion); ?>" required min="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                </div>
            </div>
            <br>
            <div class="d-flex justify-content-center">
                <button type="submit" class="btn text-white mb-3 w-25" style="background-color: #0D5C75;">Guardar Cambios</button>
                <a href="<?php echo e(route('promociones')); ?>" class="btn btn-secondary mb-3 w-25 ml-2">Cancelar</a>
            </div>
        </form>
    </div>
</div>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        servicioInput.addEventListener('input', function() {
            ...
            if (query.length >= 2) {
                fetch(`<?php echo e(route('servicios.search')); ?>?query=${query}`)
...
<?php echo $__env->make('dashboard.layout.app_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Miguel\IdeaProjects\Shine-Go\resources\views\dashboard\promociones\edit.blade.php ENDPATH**/ ?>