...
<div class="card">
    ...
    <div class="card-body">
        <form id="promocion-form" action="{{ route('promociones.update', $promocion->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nombre" name="nombre" value="{{ $promocion->nombrePromocion }}" required autocomplete="off">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="servicio" value="{{ $promocion->servicio->nomServicio }}" required autocomplete="off">
                        <input type="hidden" id="servicio_id" name="servicio_id" value="{{ $promocion->servicio_id }}">
